...
module Api.Enum.Tasks_deletable_column exposing (..)
...
type Tasks_deletable_column
    ...
    | User
    | Metadata
list : List Tasks_deletable_column
list =
...
decoder : Decoder Tasks_deletable_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Tasks_deletable_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
        )
        

{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Tasks_deletable_column -> String
toString enum____ =
    case enum____ of
        Ulid ->
                "ulid"
...
-}
fromString : String -> Maybe Tasks_deletable_column
