...
module Api.Enum.Tasks_waiting_column exposing (..)
...
type Tasks_waiting_column
    ...
    | User
    | Metadata
list : List Tasks_waiting_column
list =
...
decoder : Decoder Tasks_waiting_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Tasks_waiting_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
        )
        

{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Tasks_waiting_column -> String
toString enum____ =
    case enum____ of
        Ulid ->
                "ulid"
...
-}
fromString : String -> Maybe Tasks_waiting_column
