...
module Api.Enum.Tasks_ready_column exposing (..)
...
decoder : Decoder Tasks_ready_column
decoder =
  Decode.string
    |> Decode.andThen
        (\string -> case string of
            ...
            _ ->
              Decode.fail ("Invalid Tasks_ready_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
        )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Tasks_ready_column -> String
toString enum____ =
  case enum____ of
    Ulid ->
      "ulid"
...
-}
fromString : String -> Maybe Tasks_ready_column
