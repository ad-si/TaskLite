...
-}
insert_task_to_tag :
  (InsertTaskToTagOptionalArguments -> InsertTaskToTagOptionalArguments)
...
-}
insert_task_to_note :
  (InsertTaskToNoteOptionalArguments -> InsertTaskToNoteOptionalArguments)
...
-}
insert_tasks :
  (InsertTasksOptionalArguments -> InsertTasksOptionalArguments)
